...
def crear_directorios():
    carpetas = ["Configuracion", "Facturas"]
...
#ingreso de datos ddel cliente
        ...
        Button(frame, text="Generar y Enviar Factura", bg="#27ae60", fg="white",
               command=self.generar_factura).grid(row=6, columnspan=2, pady=10)
...
# calculo de factura
    ...
    def enviar_correo(self, destinatario, archivo_pdf):
        ...
        msg.set_content("Adjunto encontrará su factura de energía.")

        with open(archivo_pdf, "rb") as f:
            msg.add_attachment(f.read(), maintype="application",
                               subtype="pdf", filename=os.path.basename(archivo_pdf))
        ...
        try:
            ...
            messagebox.showinfo("Éxito", "Factura generada y enviada")
